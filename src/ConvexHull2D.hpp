...
template <class T>
bool ConvexHull2D<T>::pointInTriangle(const Step<T>& p1, const Step<T>& p2, const Step<T>& p3, const Step<T>& p)
{
...
// sequence of the points matters, must be counterclockwise
template <class T>
bool ConvexHull2D<T>::pointInQuadrilateral(const Step<T>& p1, const Step<T>& p2, const Step<T>& p3, const Step<T>& p4, const Step<T>& p)
{
    bool checkSide1 = side(p1, p2, p) >= 0;
    bool checkSide2 = side(p2, p3, p) >= 0;
...
// sequence of the points matters, must be counterclockwise
template <class T>
bool ConvexHull2D<T>::pointInPolygon(const std::vector<Step<T>>& poly, const Step<T>& p)
{
